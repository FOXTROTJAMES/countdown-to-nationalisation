...
const CountdownOperators: React.FC = () => {
  ...
  const sortedOperators: TrainOperator[] = [...pendingOperators].sort((a, b) => 
        ...
        {sortedOperators.map((operator: TrainOperator, index: number) => {
          ...
          return (
            ...
            >
              ...
              <div className="text-sm text-center text-gray-600 space-y-1 mb-3">
                {/* <p><strong>Region:</strong> {operator.region}</p> */}
                <p><strong>Scheduled:</strong> {formatDate(operator.date)}</p>
              </div>

              <div className={`text-center p-3 rounded-md mb-3 ${
                countdown.expired 
                ...
                {countdown.expired ? (
                  ...
                  <div>
                    <div className="text-lg font-bold">
                      {countdown.days === 1 ? '1 day' : `${countdown.days} days`} remaining
                    </div>
